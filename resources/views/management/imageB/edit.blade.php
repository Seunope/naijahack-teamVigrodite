...
@section('title', 'Admin option image edit')
@section('content')
...
@if(isset($imageB))
    ...
    <div class="modal-body">
        ...
        <div class="row">
            {!! Form::model($imageB,['method'=>'PATCH','action'=>['ImageBsController@update',$imageB->slug]]) !!}
            {{ csrf_field() }}
        ...
        {!! Form::open(['method'=>'DELETE','action'=>['ImageBsController@destroy', $imageB->slug]]) !!}
        {{ csrf_field() }}
        <div class="">
