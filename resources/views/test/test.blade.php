...
<head>
    ...
    <title>sol.ng - CBT TEST GOING ON</title>
                                ...
                                <div class="col-md-9 col-sm-12" id="testPane">
                                    ...
                                    @if(count($questions)>1)
                                                    ...
                                                    <div class="col-md-11 col-sm-11 col-xs-10 no-margin-padding">
                                                        ...
                                                        <div class="row">
                                                            @foreach($question->qimages as $qimage)
                                                                <div class=" @if($qimage->size ==1) col-md-4 col-sm-4 col-xs-4 @elseif($qimage->size ==2) col-sm-6 col-md-6 col-xs-6 @else col-md-12 col-sm-12 col-xs-12 @endif">
                                        ...
                                        <div style="text-align: center;">
                                            <button class="submitButton" id="submitTest" title="End test" value="{{ $testId }}">Submit test</button>
                                        </div>
                                        {!! Form::close() !!}
                                    @else
