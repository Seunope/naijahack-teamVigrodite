    ...
    <div id="page-wrapper">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-suitcase"></i> All semester</h3>
            </div>
            <div class="panel-body">
                ...
                <div class="bs-example" id="" >
                    ...
                    {{--Paggination ends--}}
                    <a href="{{URL::to('/admin/semesters/create')}}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> Add a new semester</a>
                </div>
            </div>
            {{--Table ends--}}
        </div>
