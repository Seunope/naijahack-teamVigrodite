...
@section('title', 'List of Questions i uploaded')
                                        ...
                                        <div class="col-md-11 col-sm-11 col-xs-10 no-margin-padding">
                                            ...
                                            <div class="row">
                                                <div style="padding-left: 10px; padding-top:10px">
                                                    {{--<div>--}}
                                                    <small>Topic:{{$question->topic_id}}
                                                        <?php
                                                         $top = DB::table('topics')->find(1);
                                                        ?>
{{--                                                        {{DB::table('topics')->where('id', $question->topic_id)->first('name')}}--}}
                                                        {{$top->name}}
                                                    </small>
