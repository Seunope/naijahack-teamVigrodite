    ...
    <div class="container">
        ...
        <div class="topbar-right pull-right">
            <div class="socials"><a href="https://facebook.com/sol4ng" class="facebook" target="_blank"><i class="fa fa-facebook"></i></a>
                ...
                {{--<a href="/contact" class="whatsapp"><i class="fa fa-whatsapp"></i></a>--}}
                {{--<a href="#" class="pinterest"><i class="fa fa-pinterest"></i>--}}
                {{--</a><a href="#" class="blog"><i class="fa fa-rss"></i></a>--}}
                {{--<a href="#" class="dribbble"><i class="fa fa-dribbble"></i></a>--}}
            </div>
            @if(Auth::check())
                <div class="group-sign-in"><a href="/profile" class="login">{{Auth::user()->name}}&nbsp;&nbsp;&nbsp</a></div>
