<?php $__env->startSection('title', 'About sol.ng'); ?>

<?php $__env->startSection('description', 'share past question and answer with friends'); ?>
<?php $__env->startSection('keywords', 'About sol.ng, sol, solng ,past, past question and answer'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        ...
        <div class="section intro-edu">
            <div class="container">
                <div class="intro-edu-wrapper">
                    <div class="row">
                        <div class="col-md-5">
                            <img src="<?php echo e(url('assets/images/solng/four.jpg')); ?>" alt="" class="intro-image fadeInLeft animated wow"/>
                            <img src="<?php echo e(url('assets/images/solng/eleven.jpg')); ?>" alt="" class="intro-image fadeInLeft animated wow"/>
                        </div>
                        <div class="col-md-7">
                            <div class="intro-title">About <b>sol.ng</b> ?</div>
                            <div class="intro-content">
                                <?php /*<p>sol.ng is a platform made by student for student to get all our past questions solved by fellow students.<br/>*/ ?>
                                <?php /*Is just a abunch of student helping one another to solve questions.</p>*/ ?>
                                ...
                                <?php /*<p>Is a website where you get solution to past questions which a fellow student has solved and also solve past questions for students too.<br>*/ ?>
                                <?php /*If we keep solving for one another with time all past question will got solved.<br>*/ ?>
                                <?php /*Which will be of help to all of us in preparing for our examinations, tests, assignments and even outside the school.*/ ?>
                                <?php /*</p></div>*/ ?>
                            </div>
                            ...
                            <div class="content">
                                <div class="col-sm-3">
                                    <div class="progress-bar-number">
                                        <div data-from="0" data-to="<?php echo e(isset($AllSchools) ? $AllSchools : ''); ?>" data-speed="1000" class="num">0</div>
                                        <p class="name-inner">schools</p>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="progress-bar-number">
                                        <div data-from="0" data-to="<?php echo e(isset($AllCourses) ? $AllCourses : ''); ?>" data-speed="1000" class="num">0</div>
                                        <p class="name-inner">courses</p>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="progress-bar-number">
                                        <div data-from="0" data-to="<?php echo e(isset($AllUsers) ? $AllUsers : ''); ?>" data-speed="1000" class="num"><?php echo e(isset($AllUsers) ? $AllUsers : ''); ?></div>
                                        <p class="name-inner">members</p>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="progress-bar-number">
                                        <div data-from="0" data-to="<?php echo e(isset($AllDepartments) ? $AllDepartments : ''); ?>" data-speed="1000" class="num">0</div>
                ...
                <div id="people-talk" data-ride="carousel" data-interval="5000" class="slider-talk-about-us-wrapper carousel slide">
                    <div role="listbox" class="slider-talk-about-us-content carousel-inner">
                        <?php foreach($testimonies as $testimony): ?>
                            <div class="peopel-item item <?php if(($num++)==2): ?> active  <?php endif; ?>" ><p class="peopel-comment">"<?php echo e(isset($testimony->body) ? $testimony->body : ''); ?>"</p>
                                <div class="group-peole-info">
                                    <div class="peopel-avatar">
                                    <img src="<?php if(isset($testimony->path[15])): ?> <?php echo e(isset($testimony->path) ? $testimony->path : ''); ?> <?php else: ?> /User_images/avatar3.jpg <?php endif; ?>" alt="<?php echo e(isset($testimony->name) ? $testimony->name : ''); ?>" class="img-responsive" style="width: 120px; height: 120px; max-width: 120%;" /></div>
                                    <div class="peopel-name"><?php echo e(isset($testimony->name) ? $testimony->name : ''); ?></div>
                                    <div class="people-job"><?php echo e(isset($testimony->email) ? $testimony->email : ''); ?></div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
        ...
        <script type="text/javascript" src="<?php echo e(URL('/assets/libs/wow-js/wow.min.js')); ?>"></script>
