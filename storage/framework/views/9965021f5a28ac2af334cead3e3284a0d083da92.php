                                ...
                                <div class="content-widget"><p>Sol.ng is solve and upload past question platform.
                                    ...
                                    <div class="info-list">
                                        <ul class="list-unstyled">
                                            ...
                                            <?php /*<li><i class="fa fa-map-marker"></i><a href="#"><p>Adenike Ogb.</p>*/ ?>
                                                    <?php /*<p>Nigeria</p></a></li>*/ ?>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <?php /*<li><i class="fa fa-angle-right"></i><a href="#">Why Edugate</a></li>*/ ?>
                                                    <?php /*<li><i class="fa fa-angle-right"></i><a href="#">Social Media</a></li>*/ ?>
                                                    <?php /*<li><i class="fa fa-angle-right"></i><a href="#">Site Map</a></li>*/ ?>
                                                </ul>
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <?php /*<li><i class="fa fa-angle-right"></i><a href="#">Blog Post</a></li>*/ ?>
                                                    <?php /*<li><i class="fa fa-angle-right"></i><a href="#">Help Topic</a></li>*/ ?>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6 sd380">
                            <div class="mailing-widget widget">
                                ...
                                <div class="content-wiget"><p>Sign up for our news letter.</p>
                                    ...
                                    <?php echo Form::open(['method'=>'POST','action'=>'MailingController@store']); ?>
            ...
            <div class="hyperlink">
                <div class="pull-left hyper-left">
                    <ul class="list-inline">
                        ...
                        <li><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
                        <?php if(Auth::check()): ?>
                        <li><a href="/profile"> <?php echo e(Auth::user()->name); ?></a></li>
